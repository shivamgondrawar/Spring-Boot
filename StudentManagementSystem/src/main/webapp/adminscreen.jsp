...
<body>
	<div class="card">
		<nav class="d-flex justify-content-between p-2 border border-primary">
			<img src="images/download.png" width="100px" height="70px">
			<div class="pt-2">
				<a href="#enroll">
		...
		<section class="vh-100 gradient-custom enroll mt-5" id="enroll">
									...
									<div class="row">
										...
										<div class="col">
											<select class="select form-control-sm" name="batchNumber">
												...
												<option value="FDJ-170">FDJ-170</option>
		...
		<section class="view" style="height: 530px" id="view">
			<h1 class="text-centre">Student Detail !!</h1>
